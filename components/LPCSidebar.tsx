...
interface LPCSidebarProps {
    className?: string;
}

export default function LPCSidebar({ className = "" }: LPCSidebarProps) {
    ...
    const navItems = [
        ...
        },
        {
            ...
            icon: Grid,
            label: "Overview",
            active: pathname === "/lpc/dashboard",
        },
        {
            href: "/lpc/patients",
            icon: Users,
            label: "Clients",
            active: pathname === "/lpc/patients",
        },
        {
            href: "/lpc/schedule",
            icon: Calendar,
            label: "Schedule",
            active: pathname === "/lpc/schedule",
        },
        {
            href: "/lpc/messages",
            icon: MessageSquare,
            label: "Chats",
            active: pathname === "/lpc/messages",
        },
        // Adding these as they might be relevant or were in other roles, 
        // but based on DoctorSidebar, only the above were present.
        // I will stick to what DoctorSidebar had.
    ];
        ...
        <>
            ...
            {isMobile && (
                <button
                    ...
                    className="fixed top-4 left-4 z-50 p-3 bg-white rounded-lg shadow-md lg:hidden hover:bg-gray-50 transition-colors min-h-11 min-w-11"
