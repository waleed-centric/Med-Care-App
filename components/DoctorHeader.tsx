					...
					<nav className="hidden lg:flex items-center space-x-9">
						<Link
							className={`hover:text-brand-primary transition-colors ${
								isActive("/doctor/messages") ? "text-brand-primary font-semibold" : ""
							}`}
						...
						<Link
							className={`hover:text-brand-primary transition-colors ${
								isActive("/doctor/client") ? "text-brand-primary font-semibold" : ""
							}`}
							href="/doctor/client"
						>
							Client
					...
					<nav className="lg:hidden bg-white border-t flex flex-col space-y-1 px-4 py-4 animate-slide-in">
						<Link
							...
							className={`px-4 py-3 rounded-md hover:bg-gray-50 transition-colors ${
								isActive("/doctor/messages") ? "bg-brand-primary text-white" : ""
							}`}
						>
							Messaging
						</Link>
						<Link
							...
							href="/doctor/client"
							className={`px-4 py-3 rounded-md hover:bg-gray-50 transition-colors ${
								isActive("/doctor/client") ? "bg-brand-primary text-white" : ""
							}`}
						>
							Client
						</Link>
